...
#
# Script generated by Vivado on Mon May 05 12:16:48 +0530 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_pipeline.sh
...
#
# Usage        : tb_pipeline.sh
#                tb_pipeline.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_pipeline.sh [-reset_run]
#                tb_pipeline.sh [-reset_log]
#                tb_pipeline.sh [-help]
#
...
# script info
echo -e "tb_pipeline.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_pipeline.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tb_pipeline xil_defaultlib.tb_pipeline xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_pipeline -key {Behavioral:sim_1:Functional:tb_pipeline} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_pipeline.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_pipeline.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_pipeline.sh [-help]\n\
Usage: tb_pipeline.sh [-step]\n\
Usage: tb_pipeline.sh [-lib_map_path]\n\
Usage: tb_pipeline.sh [-reset_run]\n\
Usage: tb_pipeline.sh [-reset_log]\n\
Usage: tb_pipeline.sh [-keep_index]\n\
Usage: tb_pipeline.sh [-noclean_files]\n\n\
