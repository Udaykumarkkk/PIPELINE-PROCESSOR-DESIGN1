...
#
# Script generated by Vivado on Wed Apr 30 13:47:23 +0530 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pipelined_processor_tb.sh
...
#
# Usage        : pipelined_processor_tb.sh
#                pipelined_processor_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pipelined_processor_tb.sh [-reset_run]
#                pipelined_processor_tb.sh [-reset_log]
#                pipelined_processor_tb.sh [-help]
#
...
# script info
echo -e "pipelined_processor_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pipelined_processor_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pipelined_processor_tb xil_defaultlib.pipelined_processor_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pipelined_processor_tb -key {Behavioral:sim_1:Functional:pipelined_processor_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pipelined_processor_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pipelined_processor_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pipelined_processor_tb.sh [-help]\n\
Usage: pipelined_processor_tb.sh [-step]\n\
Usage: pipelined_processor_tb.sh [-lib_map_path]\n\
Usage: pipelined_processor_tb.sh [-reset_run]\n\
Usage: pipelined_processor_tb.sh [-reset_log]\n\
Usage: pipelined_processor_tb.sh [-keep_index]\n\
Usage: pipelined_processor_tb.sh [-noclean_files]\n\n\
